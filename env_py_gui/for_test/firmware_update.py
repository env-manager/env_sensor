...
# temp_img = Image.open(resource_path('/home/orangepi/env_sensor/env_py_gui/img/1.png'))
temp_img = Image.open(resource_path('/home/orangepi/env_sensor/env_py_gui/img/1.png'))
resized_temp_img = temp_img.resize((20, 20), Image.ANTIALIAS)

# photo1 = PhotoImage(file=resource_path('/home/orangepi/env_sensor/env_py_gui/img/1.png'))
photo1 = ImageTk.PhotoImage(resized_temp_img)
# photo1.config(width=20, height=20)
photo2 = PhotoImage(file=resource_path('/home/orangepi/env_sensor/env_py_gui/img/2.png'))      
# 그냥 path를 적어줘야하는데... 후..
