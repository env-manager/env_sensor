...
############################################################################################################################################################
############################################################################################################################################################
        description_frame = tk.Frame(sensor_description_part, bg='black')
...
############################################################################################################################################################
        ...
        # 1 - Sensor gauge
        # self.get_image(sensor_value_part, '/home/orangepi/env_sensor/env_py_gui/img/gauge/gage-12.png',700,50,row=0,column=0, sticky='EWS',pady=10)
        self.sensor_gauge = self.get_image_instance(sensor_value_part, '/home/orangepi/env_sensor/env_py_gui/img/gauge/gage-12.png',700,50,row=0,column=0, sticky='EWS',pady=10)
    ...
    def change_image(self,sensor_name):
        ...
        self.after(3000, self.change_image, args=self.controller.sensor_name)
